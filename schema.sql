...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-12-2025 a las 21:53:19
...
--
ALTER TABLE `historial_compras`
  ADD CONSTRAINT `historial_compras_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id`),
  ADD CONSTRAINT `historial_compras_ibfk_2` FOREIGN KEY (`id_producto`) REFERENCES `productos` (`id`);
