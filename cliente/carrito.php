<?php
/**
 * Shopping Cart Page for Techecommerce
 *
 * @var array<string, mixed> $_SESSION Session data
 * @var Auth $auth Global authentication instance
 * @var PDO $db Global database instance
 */
        ...
        switch ($_POST['action']) {
            case 'add':
                ...
                if ($product) {
                    ...
                    $cart = $_SESSION['cart'] ?? [];
                    $currentInCart = isset($cart[$productId]) ? (int)$cart[$productId] : 0;
                    $newQuantity = min($quantity, (int)$product['stock'] - $currentInCart);
            ...
            case 'update':
                ...
                if ($product) {
                    /** @var array<int, int> $cart */
                    $cart = $_SESSION['cart'] ?? [];
                    $maxQuantity = min($quantity, (int)$product['stock']);
...
/** @var array<int|string, array<string, mixed>> $cartItems */
?>
<!DOCTYPE html>
<html lang="es">
...
<body>
    <div class="header">
        ...
        <div class="header-actions">
            <span>Bienvenido, <?php /** @var string $email */
            $email = $_SESSION['user_email'] ?? ''; 
            echo htmlspecialchars((string)$email); ?></span> <a href="<?php echo BASE_URL; ?>cliente/carrito.php" class="btn btn-primary">
                Carrito (<?php echo isset($_SESSION['cart']) ? (int)array_sum((array)$_SESSION['cart']) : 0; ?>)
            </a>
            ...
            <div class="cart-container">
                <div class="cart-items">
                    ...
                    <div class="cart-content">
                        <?php /** @var array{product: array{id: int, nombre: string, imagen_url: string, precio: float, stock: int}, quantity: int, subtotal: float} $item */
